        ...
        try:
            ...
            for row in raw:
                ...
                bar = OHLCV_Bar(
                    ...
                    timeframe=internal_tf, asset=asset
                )
                all_bars.append(bar)
...
def main():
    print("Fetching 3 months of BTC data...")
    ...
    h1_bars = fetch_all_bars('binance', 'BTC/USDT', '1h', start_ms, end_ms)
    d1_bars = fetch_all_bars('binance', 'BTC/USDT', '1d', start_ms, end_ms)
    ...
    h1_warmup = fetch_all_bars('binance', 'BTC/USDT', '1h', warmup_start_ms, start_ms)
    d1_warmup = fetch_all_bars('binance', 'BTC/USDT', '1d', warmup_start_ms, start_ms)
